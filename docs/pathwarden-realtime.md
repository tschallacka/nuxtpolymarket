...
The server sends a full map and entity/world snapshot on connection. Subsequent world updates are emitted at tick boundaries. A reconnect receives a fresh full snapshot and may resend only still-pending semantic commands.
