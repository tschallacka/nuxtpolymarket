...
const baseSymbols = Object.keys(BOS_SYMBOL_META) as BosBaseSymbol[]
const base = useSpriteTuner(baseSymbols, BOS_SYMBOL_META, BOS_SPRITE_SRC, BOS_SHEET_W, BOS_SHEET_H, 'BOS_SYMBOL_META', 'BosBaseSymbol')

const bonusSymbols = Object.keys(BOS_BONUS_SYMBOL_META) as BosBonusSymbol[]
const bonus = useSpriteTuner(bonusSymbols, BOS_BONUS_SYMBOL_META, BOS_BONUS_SPRITE_SRC, BOS_BONUS_SHEET_W, BOS_BONUS_SHEET_H, 'BOS_BONUS_SYMBOL_META', 'BosBonusSymbol')
</script>
  ...
  <div class="mx-auto max-w-7xl px-4 py-6">
    <div class="mb-6">
      <h1 class="text-xl font-black">
        Book of Shadows — sprite tuner
      </h1>
      <p class="text-sm text-muted">
        Adjust each symbol's crop rect until the preview and the overlay line up cleanly, then copy the generated code back into <code>app/utils/bookofshadows-sprite.ts</code>.
      </p>
    </div>
    ...
    <div class="mb-6 overflow-x-auto rounded-lg border border-default bg-elevated/40 p-3">
      ...
      >
        <img
          ...
          :style="{ width: `${base.SHEET_DISPLAY_W}px`, height: `${base.SHEET_DISPLAY_H}px` }"
          alt="Book of Shadows base sprite sheet"
        >
    ...
    <div class="mb-6 overflow-x-auto rounded-lg border border-default bg-elevated/40 p-3">
      ...
      >
        <img
          :src="BOS_BONUS_SPRITE_SRC"
          class="pointer-events-none absolute inset-0"
          :style="{ width: `${bonus.SHEET_DISPLAY_W}px`, height: `${bonus.SHEET_DISPLAY_H}px` }"
          alt="Book of Shadows bonus sprite sheet"
        >
    ...
    <div class="grid grid-cols-2 gap-3 sm:grid-cols-3 lg:grid-cols-5">
      ...
      >
        <div class="flex flex-col items-center gap-2">
          ...
          <p class="text-[11px] text-muted">
            {{ BOS_BONUS_SYMBOL_META[sym].name }}
          </p>
    ...
    <div class="mt-6">
      <div class="mb-2 flex items-center justify-between">
        <p class="text-xs font-black uppercase tracking-wide text-muted">
          Generated BOS_BONUS_SYMBOL_META
        </p>
        <UButton
          size="xs"
